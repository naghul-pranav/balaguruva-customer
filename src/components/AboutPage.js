  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-6 text-blue-700 dark:text-blue-400">
        About Balaguruva Chettiar Son's Co
      </h2>
      ...
      >
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300">
          Founded in 1992, Balaguruva Chettiar Son's Co has been at the forefront of the cookware industry for over three decades. What
      ...
      >
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300">
          At Balaguruva Chettiar Son's Co, we believe in responsible manufacturing. We're committed to reducing our
      ...
      >
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300">
          ...
          innovative designers, every member of Balaguruva Chettiar Son's Co is committed to delivering excellence in
